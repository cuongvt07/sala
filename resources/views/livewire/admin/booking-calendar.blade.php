                    ...
                    <div class="bg-white p-4 rounded border border-gray-200">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" wire:model.live="check_out" wire:key="check-out-{{ $price_type }}" class="w-full px-3 py-2 text-sm rounded border-gray-300 border focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
