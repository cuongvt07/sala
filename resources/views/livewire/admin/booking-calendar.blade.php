                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4 pt-2">
                                    <div>
                                        ...
                                        <input type="date" wire:model.live="check_in" class="w-full rounded border-gray-300 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-gray-500 mb-1">Ngày trả</label>
                                        <input type="date" wire:model.live="check_out" class="w-full rounded border-gray-300 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                @if($activeTab === 'existing')
                                    <div>
                                        ...
                                        <select wire:model.live="customer_id" class="w-full rounded border-gray-300 py-2 text-sm focus:ring-blue-500 focus:border-blue-500">
