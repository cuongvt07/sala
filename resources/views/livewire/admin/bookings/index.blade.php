                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="bg-white p-3 rounded-lg border border-gray-200">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <div class="col-span-2">
                                    <div class="flex p-0.5 bg-gray-100 rounded text-center">
                                        <button type="button" wire:click="setPriceType('day')" class="flex-1 py-1.5 rounded text-xs font-bold {{ $price_type === 'day' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500' }}">Ngày</button>
                                        <button type="button" wire:click="setPriceType('month')" class="flex-1 py-1.5 rounded text-xs font-bold {{ $price_type === 'month' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500' }}">Hợp đồng</button>
                                    </div>
                                </div>
                            </div>
