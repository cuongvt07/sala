<div class="space-y-6">
    <!-- Tabs & Content -->
    <div x-data="{ dashboardTab: @entangle('activeTab') }">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            ...
            <div class="flex p-1 bg-gray-100 rounded-lg">
                <button @click="dashboardTab = 'general'" :class="dashboardTab === 'general' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'" class="px-4 py-1.5 text-sm font-medium rounded-md transition-all">
                    Vận hành
                </button>
                <button @click="dashboardTab = 'finance'" :class="dashboardTab === 'finance' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'" class="px-4 py-1.5 text-sm font-medium rounded-md transition-all">
                    Tài chính
                </button>
            </div>
        </div>

        <div x-show="dashboardTab === 'general'">
        ...
        <div x-show="dashboardTab === 'finance'" x-cloak>
            <!-- TÀI CHÍNH TAB -->
