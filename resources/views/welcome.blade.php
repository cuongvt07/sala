    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-bold text-2xl uppercase">Hệ thống quản trị SALA APARTMENT</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Quản lý đặt phòng và dịch vụ căn hộ chuyên nghiệp.
                </p>
                <li class="flex items-center gap-4 py-2 relative">
                    <span>Vui lòng đăng nhập để bắt đầu phiên làm việc.</span>
                </li>
            ...
            <div
                class="bg-slate-950 relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">
                <img src="{{ asset('sala.png') }}" alt="Sala Logo" class="w-full h-full object-cover">
                <div
